...
const MyEnrollments = () => {
 ...
 useEffect(()=>{
  ...
  return (
    <>
    <div className="md:px-36 px-8 pt-10 bg-gradient-to-b from-red-300 to-white">
      <h1 className="text-2xl font-semibold">My Enrollments</h1>
      <table className="md:table-auto table-fixed w-full overflow-hidden border   mt-10">
        <thead className="text-gray-900 border-b border-black text-sm text-left max-sm:hidden">
          <tr>
            ...
            <tr key={i} className="border-b border-gray-500/30">
              <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <Line strokeWidth={2} percent={progressArray[i] ? (progressArray[i].lectureCompleted *100)/progressArray[i].totalLectures : 0} className = "bg-gray-300 rounded-full" ></Line>
                </div>
              </td>
              ...
              <td className="px-4 py-3 max-sm:text-right">
                <button
                  className="px-3 cursor-pointer sm:px-5 py-1.5 sm:py-2 bg-red-600 rounded-2xl max-sm:text-xs text-white"
