...
const CoursesSection = () => {
  const{allCourses} = useContext(AppContext)
   ...
   return (
    <div className='pb-10 relative clip-diagonal bg-gradient-to-b from-white to-blue-300 w-full flex items-center justify-center flex-col gap-5 pt-20 md:px-20 sm:px-15 px-10'>
